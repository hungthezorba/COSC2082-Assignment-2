	...
	while (true) {
		...
		// Delete customer menu
			...
			while (true) {
				...
				if (input == "1") {
					while (true) {
						cout << "PROMPT: Enter customer ID to delete: ";
						cin >> input;
						// Check ID format
				    ...
				    cin.ignore();
					while (true) {
						cout << "PROMPT: Enter customer name to delete: ";
						getline(cin, input);
						// Check title format
		...
		// Update customer menu
			...
			while (true) {
				...
				if (input == "1") {
					cin.ignore();
					while (true) {
						cout << "PROMPT: Enter customer ID to update: ";
						getline(cin, input);
						if (validateCustomerID(input, "input"))
							break;
					}
					...
					cin.ignore();
					while (true) {
						cout << "PROMPT: Enter customer name to update: ";
						getline(cin, input);
						if (validateCustomerName(input, "input"))
							break;
					}
		...
		// Search customer menu
			...
			while (true) {
				...
				if (input == "1") {
					while (true) {
						cout << "PROMPT: Enter customer ID to search: ";
						cin >> input;
						if (validateCustomerID(input, "input"))
							break;
					}
					...
					cin.ignore();
					while (true) {
						cout << "PROMPT: Enter customer name to search: ";
						getline(cin, input);
						if (validateCustomerName(input, "input"))
							break;
					}
